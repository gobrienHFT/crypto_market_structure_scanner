...
def _row_bool(row: pd.Series | dict[str, Any], key: str) -> bool:
...
def _flag_json_record(row: pd.Series | dict[str, Any], *, timestamp: str, scan_mode: str, holder_text: str, raw_output: str = "") -> dict[str, Any]:
    ...
    return {
        ...
        "terminal_structure_edge_score": _first_float(row, "terminal_structure_edge_score"),
        "terminal_control_plane_score": _first_float(row, "terminal_control_plane_score"),
        "terminal_distribution_pressure_score": _first_float(row, "terminal_distribution_pressure_score"),
        "terminal_pre_ignition_quality_score": _first_float(row, "terminal_pre_ignition_quality_score"),
        ...
        "cex_deposit_flow_score": _first_float(row, "cex_deposit_flow_score"),
        "cex_deposit_flow_source": _row_text(row, "cex_deposit_flow_source"),
        "cex_deposit_24h_source_url": _row_text(row, "cex_deposit_24h_source_url"),
        "cex_deposit_24h_target_exchanges": _row_text(row, "cex_deposit_24h_target_exchanges"),
        "cex_deposit_24h_notional_usd": _first_float(row, "cex_deposit_24h_notional_usd"),
        "cex_deposit_24h_notional_to_ask_depth_pct": _first_float(row, "cex_deposit_24h_notional_to_ask_depth_pct"),
        "cex_deposit_flow_error": _row_text(row, "cex_deposit_flow_error"),
        "cex_deposit_inventory_stress_score": _first_float(row, "cex_deposit_inventory_stress_score"),
        "cex_deposit_inventory_stress_note": _row_text(row, "cex_deposit_inventory_stress_note"),
        "archetype_match_score": _first_float(row, "archetype_match_score"),
        "archetype_best_match": _row_text(row, "archetype_best_match"),
        "archetype_match_note": _row_text(row, "archetype_match_note"),
        "early_pump_radar_score": _first_float(row, "early_pump_radar_score"),
        "early_pump_state": _row_text(row, "early_pump_state"),
        "early_pump_primary_signal": _row_text(row, "early_pump_primary_signal"),
        "early_pump_confirmed_target_flow": _row_bool(row, "early_pump_confirmed_target_flow"),
        "early_pump_next_check": _row_text(row, "early_pump_next_check"),
        "timing_score": _first_float(row, "timing_score"),
        "timing_inventory_response_score": _first_float(row, "timing_inventory_response_score"),
