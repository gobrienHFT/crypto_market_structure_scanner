...
Source: fresh Deep scan at 2026-05-28 09:22:00 UTC | Transfer floor: 20.00K tokens | Lookback: 24h | Style: both | Min early score: 60 | Min RAVE/LAB archetype: 0 | Whale gate: >= 90.0% | Squeeze gate: >= 50 | History gate: >= 60d | Holder evidence required: True | Binance+Bitget required: True | Dormant 2m required: True | Quiet required: True | Target flow required: False | High breakout windows: 1D,2D,3D,4D,5D,20D | Breakout required: False
...
/CAPUSDT | RAVE-like | early 73/100 | RAVE 58 LAB 25 | gates whale Y holderEv Y venue Y dormant2m Y squeeze Y | venues Bn Y/Bg Y/Gate N | venue ev Bn perp,8.0%; Bg 2.0%; Gate no | whale 99.8% (t10 94.0%, t100 99.8%) | holder ev chain ethereum, holders 6000, src Etherscan holder endpoint, contract 0x1111...1111 | squeeze 62 shorts 54.0% | history 180d | highs 1D,2D,3D,4D,5D | breakout 18 | CEX no target flow 0tx max n/a | control 100 float 88 | quiet 85 heat 0 | dashboard 0 latent 66 | anchor RAVEUSDT 2026-04-18 | next: watch 1D-5D highs, first volume lift, and OI expansion without chase heat
/LABXUSDT | LAB-like | early 82/100 | RAVE 56 LAB 88 | gates whale Y holderEv Y venue Y dormant2m Y squeeze Y | venues Bn Y/Bg Y/Gate Y | venue ev Bn perp,9.0%,target; Bg 2.0%; Gate target | whale 99.2% (t10 91.0%, t100 99.2%) | holder ev chain arbitrum, holders 8000, src Arbiscan holder endpoint, contract 0x2222...2222 | squeeze 58 shorts 51.0% | history 160d | highs none | breakout 18 | CEX Binance, Gate.io 2tx max 360.00K | control 99 float 84 | quiet 86 heat 0 | dashboard 0 latent 92 | anchor LABUSDT 2026-05-11 | next: watch for absorption after target-CEX inventory movement and first perp response
```
