...
Thesis gate: observed holder >= 90.0% with ETH/BNB/ARB chain+contract holder-source evidence | Venue gate: explicit Binance perp marker/share/top venue + Bitget trading evidence required; Gate is optional evidence only
...
Thesis gate: observed holder >= 90.0% with ETH/BNB/ARB chain+contract holder-source evidence | Venue gate: explicit Binance perp marker/share/top venue + Bitget trading evidence required; Gate is optional evidence only | Thesis-only: False | Thesis breakout matches: 1
...
Thesis gate: observed holder >= 90.0% with ETH/BNB/ARB chain+contract holder-source evidence | Venue gate: explicit Binance perp marker/share/top venue + Bitget trading evidence required; Gate is optional evidence only | Thesis-only: False | Thesis breakout matches: 0
