...
/ravelab [min_score] [min_archetype] [min_whale_pct] [min_squeeze_score] [min_tokens] [limit] [lookback_hours] [style] [require_quiet] [require_target_flow] [require_binance_bitget] [require_dormant_2m]
...
- a dedicated `/ravelab` strict early-structure radar requiring observed 90%+ whale concentration, Binance+Bitget venue evidence, 2-month no-chase/dormancy, and squeeze priming before ranking RAVE/LAB analogues
