...
- a dedicated `/ravelab` strict early-structure radar requiring observed 90%+ whale concentration with ETH/BNB/ARB chain+contract holder evidence, Binance+Bitget trading evidence, at least 60 days of history plus 2-month no-chase/dormancy, and squeeze priming before ranking RAVE/LAB analogues, with compact holder source/count/chain/contract evidence, venue provenance, and optional 1D/2D/3D/4D/etc high-breakout filtering after those hard gates
